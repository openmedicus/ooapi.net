...
namespace org.openoces.ooapi.certificate
{
    ...
    public abstract class OcesCertificate : IOcesCertificate
    {
        ...
        protected OcesCertificate(X509Certificate2 certificate, Ca issuingCa)
        {
            ...
            IssuingCa = issuingCa;
            SubjectSerialNumber = ExtractSubjectSerialNumber(certificate);
        }
        ...
        /// </returns>
        public CertificateStatus ValidityStatus(DateTime date)
        {
        ...
        {
            get { return X509CertificatePropertyExtrator.GetOcspUrl(Certificate); }
        }
        ...
        {
            get { return X509CertificatePropertyExtrator.GetCaIssuerUrl(Certificate); }
        }
        ...
        {
            get { return X509CertificatePropertyExtrator.GetEmailAddress(Certificate); }
        }
        ...
        {
            get { return CrlDistributionPointsExtractor.ExtractCrlDistributionPoints(Certificate); }
        }
        ...
        public X509Certificate2 ExportCertificate()
        {
            return Certificate;
        }
    }
