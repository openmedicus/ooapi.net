...
namespace org.openoces.ooapi.certificate
{
    public interface IOcesCertificate
    {
        ...
        List<X509Certificate2> CertificateChain { get; }
        ...
        /// </returns>
        CertificateStatus ValidityStatus(DateTime date);
        ...
        bool ValidOnDate(DateTime date);
        ...
        X509Certificate2 ExportCertificate();
    }
}
