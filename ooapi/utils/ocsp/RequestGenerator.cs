...
namespace org.openoces.ooapi.utils.ocsp
{
    public class RequestGenerator
    {
        ...
        public static OcspReqAndId CreateOcspRequest(X509Certificate2 rootCertificate, string serialNumber)
        {
        ...
        static Asn1OctetString CreateIssuerNameHash(X509Certificate rootCertificate)
        {
