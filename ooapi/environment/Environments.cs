...
namespace org.openoces.ooapi.environment
{
    ...
    public class Environments
    {
        ...
        protected static IEnumerable<OcesEnvironment> TheTrustedEnvironments = new[] { OcesEnvironment.OcesII_DanidEnvProd };
        private static OcesEnvironment oces_II_environment;

        public static void setOces_II_Environment(OcesEnvironment oces_2_environment)
        {
            oces_II_environment = oces_2_environment;
        }

        public static OcesEnvironment getOces_II_Environment()
        {
            return oces_II_environment;
        }
