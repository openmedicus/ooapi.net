...
namespace org.openoces.securitypackage
{
    ...
    public class SignHandler
    {
        ...
        public static SignatureValidationStatus ValidateSignatureAgainstAgreement(string loginData, string agreement, string stylesheet, string challenge, string logonto)
        {
            ...
            var signatureMatches = SignatureMatches(encodedSignature, agreement, stylesheet, opensignSignature);
            SignatureProperty ruidProperty = GetSignatureProperty(opensignSignature, "rememberUseridToken");
        ...
        public static SignatureValidationStatus validateSignatureAgainstAgreementPDF(String loginData, String encodedAgreement, String challenge, String logonto)
        {
		    var errorCodeChecker = new ErrorCodeChecker(loginData);
            if (errorCodeChecker.HasError())
            {
            ...
            var opensignSignature = CreateOpensignSignature(Base64PDFDecode(loginData));
            ...
            String encodedSignature = Base64Encode(opensignSignature.SignedDocument.SignedContent);      
        ...
        public static string Base64PDFDecode(string s)
        {
            var bytes = Convert.FromBase64String(s);
